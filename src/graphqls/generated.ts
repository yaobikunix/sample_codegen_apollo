...
export type FilmItemFragment = { __typename?: 'Film', id: string, title?: string | null, releaseDate?: string | null, director?: string | null };
...
export type AllFilmsWithVariablesQueryQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', edges?: Array<{ __typename?: 'FilmsEdge', node?: { __typename?: 'Film', id: string, title?: string | null, releaseDate?: string | null, director?: string | null } | null } | null> | null } | null };
...
export const FilmItemFragmentDoc = gql`
  ...
  director
    ...
    `;
export const AllFilmsWithVariablesQueryDocument = gql`
...
/**
 * __useAllFilmsWithVariablesQueryQuery__
 *
 * To run a query within a React component, call `useAllFilmsWithVariablesQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllFilmsWithVariablesQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllFilmsWithVariablesQueryQuery({
 *   variables: {
 *      first: // value for 'first'
 *   },
 * });
 */
export function useAllFilmsWithVariablesQueryQuery(baseOptions: Apollo.QueryHookOptions<AllFilmsWithVariablesQueryQuery, AllFilmsWithVariablesQueryQueryVariables> & ({ variables: AllFilmsWithVariablesQueryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllFilmsWithVariablesQueryQuery, AllFilmsWithVariablesQueryQueryVariables>(AllFilmsWithVariablesQueryDocument, options);
      }
export function useAllFilmsWithVariablesQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllFilmsWithVariablesQueryQuery, AllFilmsWithVariablesQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllFilmsWithVariablesQueryQuery, AllFilmsWithVariablesQueryQueryVariables>(AllFilmsWithVariablesQueryDocument, options);
        }
export function useAllFilmsWithVariablesQuerySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllFilmsWithVariablesQueryQuery, AllFilmsWithVariablesQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllFilmsWithVariablesQueryQuery, AllFilmsWithVariablesQueryQueryVariables>(AllFilmsWithVariablesQueryDocument, options);
        }
export type AllFilmsWithVariablesQueryQueryHookResult = ReturnType<typeof useAllFilmsWithVariablesQueryQuery>;
export type AllFilmsWithVariablesQueryLazyQueryHookResult = ReturnType<typeof useAllFilmsWithVariablesQueryLazyQuery>;
export type AllFilmsWithVariablesQuerySuspenseQueryHookResult = ReturnType<typeof useAllFilmsWithVariablesQuerySuspenseQuery>;
export type AllFilmsWithVariablesQueryQueryResult = Apollo.QueryResult<AllFilmsWithVariablesQueryQuery, AllFilmsWithVariablesQueryQueryVariables>;